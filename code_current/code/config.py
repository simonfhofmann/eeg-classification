...
BASELINE_DURATION_MEAN = 8  # Mean duration of the baseline
BASELINE_DURATION_JITTER = 0.75  # Max +/- jitter (e.g., 3.75 +/- 0.75 -> 3.0s to 4.5s)

# Duration to play each music stimulus
STIMULUS_DURATION = 32.0
#STIMULUS_DURATION = 2.0

# Fixed duration for the participant to enter their ratings
FAMILIARITY_RESPONSE_DURATION = 100  # Time for familiarity question
LIKING_RESPONSE_DURATION = 8.0       # Time for liking question
...
MARKERS = {
    ...
    # e.g., Trial 1 Stimulus Start = 10 + 1 = 101
    #      Trial 40 Stimulus Start = 10 + 40 = 140
    "STIMULUS_START_BASE": 2,

    # Encoding the response as: 20 + (familiarity * 10) + liking
    # e.g., Familiarity=4, Liking=2 -> 20 + 40 + 2 = 242
    # e.g., Familiarity=1, Liking=5 -> 20 + 10 + 5 = 215
    "RESPONSE_ID_BASE": 20,
}
